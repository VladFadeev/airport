...
import airport.models.ClassificationLevel;
import airport.models.ExperimentalType;
...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        boolean isTransportMilitaryPlanes = true;
        for (MilitaryPlane militaryPlane : transportMilitaryPlanes) {
            if ((militaryPlane.getType() != MilitaryType.TRANSPORT)) {
                isTransportMilitaryPlanes = false;
                break;
            }
        }
        assertTrue(isTransportMilitaryPlanes);
    }
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        ...
        assertTrue(hasBomberInMilitaryPlanes);
    }
